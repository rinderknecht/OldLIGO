...
let print_tez (node : (lexeme * Int64.t) wrap) =
  Int64.to_string (snd node#payload) ^ "tez" |> string
...
and print_P_Tez (node : (lexeme * Int64.t) wrap) = print_tez node
...
and print_E_Tez (node : (lexeme * Int64.t) wrap) = print_tez node
