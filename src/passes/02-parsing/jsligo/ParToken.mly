...
%token <string Wrap.t> New      "new"      [@recover.expr Token.wrap_new      $loc]
...
%token <string Wrap.t> Static   "static"   [@recover.expr Token.wrap_static   $loc]
...
%token <string Wrap.t * string Wrap.t> SEMI_ELSE "; else" (* [@recover.expr ???] *)
