...
namespace Entry_no_metadata {
  ...
  class Entry_no_metadata {
    @entry
    main = (_p: param, s: storage): [list<operation>, storage] => [[], s]
  }
}
...
namespace Entry_valid_metadata {
  ...
  class Entry_valid_metadata {
    @entry
    main = (_p: param, s: storage): [list<operation>, storage] => [[], s]

    off_view = (p: int, s: storage): int => p + s.data
  }
}
