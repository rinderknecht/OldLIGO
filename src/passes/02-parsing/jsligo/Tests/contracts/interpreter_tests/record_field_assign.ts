...
const test_nested_record_assign_level2 = ((() => {
    ...
    r.x.y.z = 11;
    Assert.assert(r.x.y.z == 11);

    r.x.y.z1 = 11;
    Assert.assert(r.x.y.z1 == 11);
...
const test_nested_record_assign_var_level2 = ((() => {
    ...
    r.x.y.z = a;
    Assert.assert(r.x.y.z == a);

    r.x.y.z1 = a;
    Assert.assert(r.x.y.z1 == a);
...
const test_nested_record_assign_var_level2_expr = ((() => {
    ...
    r.x.y.z = a + 1;
    Assert.assert(r.x.y.z == 12);

    r.x.y.z1 = a + 1;
    Assert.assert(r.x.y.z1 == (13 - 1));
...
const test_nested_record_assign_var_level2_record_access = ((() => {
    ...
    r.x.y.z = s.a.b.c;
    Assert.assert(r.x.y.z == 9);

    r.x.y.z1 = s.a.b.c + r.x.y.z;
    Assert.assert(r.x.y.z1 == 18);
...
const test_nested_record_assign_var_level2_module_member = ((() => {
    ...
    r.x.y.z = M.pi;
    Assert.assert(r.x.y.z == M.pi);

    r.x.y.z1 = M.pi + r.x.y.z;
    Assert.assert(r.x.y.z1 == M.pi2);
...
const test_nested_record_assign_var_level2_module_record_member = ((() => {
    ...
    Assert.assert(r.x.y.z == 4);

    r.x.y.z1 = M.val_d.p.q.r + r.x.y.z;
    Assert.assert(r.x.y.z1 == 8);
...
const test_nested_record_assign_tuple_assign_array_notation_level2 = ((() => {
    ...
    r["x"].y[2]["z"] = "Hello";
    Assert.assert(r["x"]["y"][2].z == "Hello");

    r["x"]["y"][2].z1 = 11;
    Assert.assert(r.x.y[2].z1 == 11);
